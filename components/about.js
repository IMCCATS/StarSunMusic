    ...
    <Card sx={{ minWidth: 275 }} style={{ marginTop: "15px" }}>
      <CardContent>
        ...
        <Typography variant="body2">
          ...
          <br />
          <span>
            免责声明：本网站内容来源于网络，仅提供检索服务。本网站不存储任何内容，也不承担任何责任。如果您需要使用本网站提供的检索服务，您应当自行负责获取相关内容的合法性和准确性。此外，本网站保留随时修改本声明的权利。如果您继续使用本网站，即表示您已经接受了本声明的所有修改。具体请在首页 -《用户协议与隐私政策》查看。
          </span>
          <br />
          <Accordion>
            <AccordionSummary
